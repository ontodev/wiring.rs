...
pub fn translate_subclass_of_axiom(v : &Value, m : &HashMap<String,HashSet<String>>) -> String {
...
pub fn translate_disjoint_classes_axiom(v : &Value, m : &HashMap<String,HashSet<String>>) -> String {
...
pub fn translate_disjoint_union_of_axiom(v : &Value, m : &HashMap<String,HashSet<String>>) -> String {
...
pub fn translate_equivalent_classes_axiom(v : &Value, m : &HashMap<String,HashSet<String>>) -> String {
